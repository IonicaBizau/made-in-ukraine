...
27 | [@edjafarov](https://github.com/edjafarov)/[**grail**](https://github.com/edjafarov/grail) | grail - isomorphic app framework |
...
8 | [@piranha](https://github.com/piranha)/[**tnetstrings.js**](https://github.com/piranha/tnetstrings.js) | tnetstrings javascript implementation | [:arrow_upper_right:](tnetstrings.org)
...
3 | [@sasha240100](https://github.com/sasha240100)/[**JsOs**](https://github.com/sasha240100/JsOs) | Javascript-based operation system (Runtime.js) |
...
1219 | [@bmelnychuk](https://github.com/bmelnychuk)/[**AndroidTreeView**](https://github.com/bmelnychuk/AndroidTreeView) | AndroidTreeView. TreeView implementation for android |
...
51 | [@yakivmospan](https://github.com/yakivmospan)/[**gists**](https://github.com/yakivmospan/gists) | Repository was desired and is made to store Android reusable code in a way of simple markdown files and java classes. | [:arrow_upper_right:](http://yakivmospan.com/)
...
7 | [@danylovolokh](https://github.com/danylovolokh)/[**MidPointCircleExplai…**](https://github.com/danylovolokh/MidPointCircleExplained) | This is a project that helps to understand how "Mid Point Circle" algorithm works and how it is modified for LondonEyeLayoutManager project |
...
3 | [@T-Alex](https://github.com/T-Alex)/[**DotWeb**](https://github.com/T-Alex/DotWeb) | Library of web tools for .NET |
...
8 | [@mik9](https://github.com/mik9)/[**lg_thunderg_android_…**](https://github.com/mik9/lg_thunderg_android_bootable_recovery) | ClockworkMod Recovery for LG Optimus One |
...
18 | [@BloodAxe](https://github.com/BloodAxe)/[**CloudCVBackend**](https://github.com/BloodAxe/CloudCVBackend) | A C++ backend module for CloudCV  |
...
7 | [@alco](https://github.com/alco)/[**TastyKVO**](https://github.com/alco/TastyKVO) | A simpler key-value observing API (with blocks!) |
...
4 | [@radetsky](https://github.com/radetsky)/[**perl-smpp-server**](https://github.com/radetsky/perl-smpp-server) | SMPP server written in perl.  |
...
23 | [@makasim](https://github.com/makasim)/[**PayumBundleSandbox**](https://github.com/makasim/PayumBundleSandbox) | Symfony2 application to play with PayumBundle. |
...
5 | [@stfalcon](https://github.com/stfalcon)/[**PageBundle**](https://github.com/stfalcon/PageBundle) | Simple PageBundle for Symfony2 and SonataAdmin |
...
52 | [@k-bx](https://github.com/k-bx)/[**python-semver**](https://github.com/k-bx/python-semver) | Python package to work with Semantic Versioning (http://semver.org/) |
...
6 | [@hellysmile](https://github.com/hellysmile)/[**django-mongo-session…**](https://github.com/hellysmile/django-mongo-sessions) | mongodb as Django sessions backend | [:arrow_upper_right:](https://pypi.python.org/pypi/django-mongo-sessions)
...
48 | [@le0pard](https://github.com/le0pard)/[**rwbox**](https://github.com/le0pard/rwbox) | Vagrant images for Ruby and ROR developers | [:arrow_upper_right:](http://leopard.in.ua/rwbox)
36 | [@Ptico](https://github.com/Ptico)/[**from-rack-to-rails**](https://github.com/Ptico/from-rack-to-rails) | Codecasts about how rails works |
25 | [@krasnoukhov](https://github.com/krasnoukhov)/[**gospotify**](https://github.com/krasnoukhov/gospotify) | GoSpotify is a simple service that syncs your playlists from SoundCloud, VK and Last.fm to Spotify. |
25 | [@rilian](https://github.com/rilian)/[**saas-homework**](https://github.com/rilian/saas-homework) | SAAS class @ Berkeley - homework | [:arrow_upper_right:](https://www.coursera.org/saas/)
24 | [@galetahub](https://github.com/galetahub)/[**web_video**](https://github.com/galetahub/web_video) | WebVideo allows you to inspect and process video files (ffmpeg, mencoder, flvtool2). |
22 | [@rilian](https://github.com/rilian)/[**portfolio**](https://github.com/rilian/portfolio) | app to store your portfolio, with ability to upload graphics, categorize and comment |
20 | [@le0pard](https://github.com/le0pard)/[**st_rails_example**](https://github.com/le0pard/st_rails_example) | Demo app for shared templates in rails 3 | [:arrow_upper_right:](http://st-rails-example.herokuapp.com/)
19 | [@galetahub](https://github.com/galetahub)/[**loginza**](https://github.com/galetahub/loginza) | OpenID 2.0 provider | [:arrow_upper_right:](http://loginza.ru)
13 | [@galetahub](https://github.com/galetahub)/[**rails-ckeditor-demo-…**](https://github.com/galetahub/rails-ckeditor-demo-app) | Demo app for rails-ckeditor plugin usage |
13 | [@le0pard](https://github.com/le0pard)/[**omniauth-yammer**](https://github.com/le0pard/omniauth-yammer) | OmniAuth strategy for Yammer | [:arrow_upper_right:](https://github.com/le0pard/omniauth-yammer)
10 | [@rilian](https://github.com/rilian)/[**newsletter**](https://github.com/rilian/newsletter) | This project aims to streamline delivery of quality IT reading/watching resources to curious developers |
9 | [@galetahub](https://github.com/galetahub)/[**sunrise-core**](https://github.com/galetahub/sunrise-core) | SunRize CMS Core | [:arrow_upper_right:](http://www.aimbulance.com/)
9 | [@galetahub](https://github.com/galetahub)/[**vkontakte**](https://github.com/galetahub/vkontakte) | The easiest way to access Vkontakte API and some other utils. | [:arrow_upper_right:](http://vkontakte.ru/developers.php)
8 | [@aratak](https://github.com/aratak)/[**wkhtmltopdf_for_rail…**](https://github.com/aratak/wkhtmltopdf_for_rails) | Provides WKHTMLTOPDF for ruby on rails. |
7 | [@shockone](https://github.com/shockone)/[**ansi-select**](https://github.com/shockone/ansi-select) | A simple, not full-screen, ncurses-like TUI select |
7 | [@galetahub](https://github.com/galetahub)/[**ruby2xlsx**](https://github.com/galetahub/ruby2xlsx) | Export your data to Excel. Provide two ways for export data: template or renderer. | [:arrow_upper_right:](http://www.aimbulance.com/)
7 | [@galetahub](https://github.com/galetahub)/[**sunrise**](https://github.com/galetahub/sunrise) | Mini and free CMS | [:arrow_upper_right:](http://fodojo.com/)
6 | [@Ptico](https://github.com/Ptico)/[**rubyunderhood**](https://github.com/Ptico/rubyunderhood) |  |
6 | [@Ptico](https://github.com/Ptico)/[**rspec-sequel_expecta…**](https://github.com/Ptico/rspec-sequel_expectations) | RSpec matchers for Sequel |
6 | [@le0pard](https://github.com/le0pard)/[**chef-server-example**](https://github.com/le0pard/chef-server-example) | Chef server example |
6 | [@le0pard](https://github.com/le0pard)/[**zopfli-ffi**](https://github.com/le0pard/zopfli-ffi) | Ruby wrapper for zopfli | [:arrow_upper_right:](http://leopard.in.ua/zopfli-ffi)
5 | [@galetahub](https://github.com/galetahub)/[**track_tweets**](https://github.com/galetahub/track_tweets) | Tracking tweets count, users count | [:arrow_upper_right:](http://search.twitter.com/api/)
5 | [@galetahub](https://github.com/galetahub)/[**vkontakte_oauth**](https://github.com/galetahub/vkontakte_oauth) | Vkontakte Open API (ВКонтакте) | [:arrow_upper_right:](http://vkontakte.ru/pages.php?o=-1&p=Open+API)
5 | [@galetahub](https://github.com/galetahub)/[**sunrise-file-upload**](https://github.com/galetahub/sunrise-file-upload) | Upload files |
5 | [@galetahub](https://github.com/galetahub)/[**cancan_namespace**](https://github.com/galetahub/cancan_namespace) | Add namespace for cancan authorization library |
4 | [@galetahub](https://github.com/galetahub)/[**social_profile**](https://github.com/galetahub/social_profile) | Wrapper for Omniauth profile hash |
4 | [@galetahub](https://github.com/galetahub)/[**falcon**](https://github.com/galetahub/falcon) | Encoding video files |
4 | [@le0pard](https://github.com/le0pard)/[**chef-tdd-monit**](https://github.com/le0pard/chef-tdd-monit) | Example cookbook with monit | [:arrow_upper_right:](http://leopard.in.ua/2013/12/01/chef-and-tdd/)
4 | [@aratak](https://github.com/aratak)/[**jquery_drapper**](https://github.com/aratak/jquery_drapper) | Create some widget from 'input' source. Unobtrusive | [:arrow_upper_right:](http://aratak.github.com/jquery_drapper/)
4 | [@galetahub](https://github.com/galetahub)/[**poker_history**](https://github.com/galetahub/poker_history) | Poker hands history parser | [:arrow_upper_right:](poker.ua)
4 | [@Ptico](https://github.com/Ptico)/[**signpost**](https://github.com/Ptico/signpost) | Rack router |
4 | [@krasnoukhov](https://github.com/krasnoukhov)/[**lotus-dynamodb**](https://github.com/krasnoukhov/lotus-dynamodb) | Amazon DynamoDB adapter for Lotus::Model |
3 | [@Alexey-Lukin](https://github.com/Alexey-Lukin)/[**ufujs-demo**](https://github.com/Alexey-Lukin/ufujs-demo) |  |
3 | [@galetahub](https://github.com/galetahub)/[**rails-marker**](https://github.com/galetahub/rails-marker) | Easy way to edit zoom, longitude and latitude |
3 | [@galetahub](https://github.com/galetahub)/[**share_checker**](https://github.com/galetahub/share_checker) | Get count of shared URL's in social sites (twitter, facebook, vkontakte and odnoklassniki) | [:arrow_upper_right:](http://www.aimbulance.com/)
3 | [@Ptico](https://github.com/Ptico)/[**switcher**](https://github.com/Ptico/switcher) | Switcher is simple, event-driven state machine |
3 | [@rilian](https://github.com/rilian)/[**expenses**](https://github.com/rilian/expenses) | home expenses tracker |
3 | [@le0pard](https://github.com/le0pard)/[**le0pard.github.io**](https://github.com/le0pard/le0pard.github.io) | My Blog | [:arrow_upper_right:](http://leopard.in.ua)
3 | [@Alexey-Lukin](https://github.com/Alexey-Lukin)/[**shrimp-middleware**](https://github.com/Alexey-Lukin/shrimp-middleware) |  |
2 | [@le0pard](https://github.com/le0pard)/[**smartme_backbone_201…**](https://github.com/le0pard/smartme_backbone_2012) | SmartMe Backbone 2012 | [:arrow_upper_right:](http://www.smartme.com.ua/workshops/razrabotka-veb-prilozheniy-s-ispolzovaniem-coffeescript-i-backbonejs)
2 | [@Alexey-Lukin](https://github.com/Alexey-Lukin)/[**google_parser**](https://github.com/Alexey-Lukin/google_parser) |  |
2 | [@le0pard](https://github.com/le0pard)/[**automation-git-chang…**](https://github.com/le0pard/automation-git-changelog) | Automatic git changelog |
2 | [@le0pard](https://github.com/le0pard)/[**product_fair**](https://github.com/le0pard/product_fair) | Product Fair for Railsware |
2 | [@Ptico](https://github.com/Ptico)/[**resourced**](https://github.com/Ptico/resourced) |  |
2 | [@le0pard](https://github.com/le0pard)/[**ruby_pg_pool_admin**](https://github.com/le0pard/ruby_pg_pool_admin) | Under development frontend for pgpool on ruby |
2 | [@krasnoukhov](https://github.com/krasnoukhov)/[**lines**](https://github.com/krasnoukhov/lines) | Задача на реализацию игры Lines |
2 | [@galetahub](https://github.com/galetahub)/[**yml_translator**](https://github.com/galetahub/yml_translator) | Translate your I18n files locales in one click |
2 | [@galetahub](https://github.com/galetahub)/[**simple-god**](https://github.com/galetahub/simple-god) | Simple monitoring via God | [:arrow_upper_right:](http://god.rubyforge.org/)
2 | [@galetahub](https://github.com/galetahub)/[**freeberry**](https://github.com/galetahub/freeberry) | Aimbulance project template (CMS) | [:arrow_upper_right:](http://aimbulance.com)
...
76 | [@t3hnar](https://github.com/t3hnar)/[**scala-bcrypt**](https://github.com/t3hnar/scala-bcrypt) | Scala wrapper for jBcrypt + pom.xml inside |
20 | [@t3hnar](https://github.com/t3hnar)/[**scalax**](https://github.com/t3hnar/scalax) | Extension for default scala library |
14 | [@t3hnar](https://github.com/t3hnar)/[**ev3.helloworld**](https://github.com/t3hnar/ev3.helloworld) | Mindstorms EV3 Hello World in Scala |
10 | [@sonenko](https://github.com/sonenko)/[**vsjson**](https://github.com/sonenko/vsjson) | Spray-JSON VS Json4s Performance Test |
10 | [@intracer](https://github.com/intracer)/[**scalawiki**](https://github.com/intracer/scalawiki) | scalawiki is a MediaWiki client in Scala |
9 | [@rssh](https://github.com/rssh)/[**trackedfuture**](https://github.com/rssh/trackedfuture) | small runtime + java-agent, which brings back full stacktrace for exceptions, generated inside Future callbacks (like apply, map, flatMap, etc..) |
7 | [@sonenko](https://github.com/sonenko)/[**web-system-monitor**](https://github.com/sonenko/web-system-monitor) |  |
5 | [@siman](https://github.com/siman)/[**scala-validation**](https://github.com/siman/scala-validation) | Simple validation framework for Scala |
4 | [@t3hnar](https://github.com/t3hnar)/[**scala-cqrs**](https://github.com/t3hnar/scala-cqrs) | scala-cqrs |
3 | [@rssh](https://github.com/rssh)/[**fixture-state-manage…**](https://github.com/rssh/fixture-state-management) | extension to scalatest for testing with fixture states (such as relational databases) |
3 | [@rssh](https://github.com/rssh)/[**scala-training-mater…**](https://github.com/rssh/scala-training-materials) | Matherials for scala training - project templates. |
3 | [@sonenko](https://github.com/sonenko)/[**scala-js-samples**](https://github.com/sonenko/scala-js-samples) |  |
2 | [@rssh](https://github.com/rssh)/[**stermware**](https://github.com/rssh/stermware) | termware next generation |
2 | [@t3hnar](https://github.com/t3hnar)/[**akkax**](https://github.com/t3hnar/akkax) | AkkaX |
...
23 | [@technix](https://github.com/technix)/[**frenzy**](https://github.com/technix/frenzy) | Frenzy - FreeBSD-based LiveCD | [:arrow_upper_right:](http://frenzy.org.ua/)
5 | [@snowcore](https://github.com/snowcore)/[**mage-svn-ignore**](https://github.com/snowcore/mage-svn-ignore) | Bash script for setting svn:ignore property for new Magento project |
...
46 | [@troydm](https://github.com/troydm)/[**easybuffer.vim**](https://github.com/troydm/easybuffer.vim) | easybuffer.vim - vim plugin to quickly switch between buffers |
29 | [@troydm](https://github.com/troydm)/[**easytree.vim**](https://github.com/troydm/easytree.vim) | easytree.vim - tree file manager |
22 | [@troydm](https://github.com/troydm)/[**zoomwintab.vim**](https://github.com/troydm/zoomwintab.vim) | zoomwintab vim plugin |
7 | [@timlar](https://github.com/timlar)/[**vim**](https://github.com/timlar/vim) |  |
6 | [@troydm](https://github.com/troydm)/[**pb.vim**](https://github.com/troydm/pb.vim) | pb.vim plugin for Vim to interact with Mac OS X pastebuffer |
...
```js
const madeInUkraine = require("made-in-ukraine");

console.log(madeInUkraine());
```
